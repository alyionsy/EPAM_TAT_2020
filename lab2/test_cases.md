...
3 | Вписать в первое поле (E-mail or ID) зарегестрированный email-адрес (validEmail@gmail.com), в поле Password вписать правильный пароль (random11), нажать кнопку Login | Переход на страницу корзины, в таблице товаров содержатся и товары, сохранённые в корзине аккаунта, и товары, добавленные в этой сессии до авторизации
---
