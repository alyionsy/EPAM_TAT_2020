...
0 | Пользователь находится на главной |  
1 | Перейти к форме входа нажатием на ссылку Login в правом верхнем углу сайта | Переход на страницу авторизации
2 | Вписать в первое поле (E-mail or ID) зарегестрированный email-адрес, в поле Password вписать неправильный пароль, нажать кнопку Login | Страница обновляется, оба поля очищаются, первое поле становится активным
---
...
0 | Пользователь находится на главной |  
1 | Перейти к форме входа нажатием на ссылку Login в правом верхнем углу сайта | Переход на страницу авторизации
2 | Вписать в первое поле (E-mail or ID) незарегестрированный/несуществующий email-адрес, в поле Password вписать правильный пароль, нажать кнопку Login | Страница обновляется, первое поле очищается и становится активным
---
...
### #9 Сохранение товаров в корзине при авторизации
N | STEP | EXPECTED RESULT
------------ | ------------- | -------------
0 | Пользователь не залогинен, находится на главной, в коризне находится как минимум 1 товар. В корзине аккаунта имеются другие товары |  
1 | Перейти в корзину нажатием на ссылку View Cart в правом верхнем углу сайта | Переход на страницу корзины. В таблице отображаются выбранные товары и информация о них
...
N | STEP | EXPECTED RESULT
------------ | ------------- | -------------
0 | Пользователь находится в корзине, в корзину добавлен как минимум 1 товар |  
